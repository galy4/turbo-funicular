...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9053409252786494882L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.l3.transport.inner_invoice\",\"fields\":[{\"name\":\"waybillNum\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Номер накладной\"}]}");
   ...
   */
  public RecordPk(java.lang.String waybillNum) {
   ...
   */
  public static nlmk.l3.transport.inner_invoice.RecordPk.Builder newBuilder() {
    return new nlmk.l3.transport.inner_invoice.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.inner_invoice.RecordPk.Builder newBuilder(nlmk.l3.transport.inner_invoice.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.inner_invoice.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.inner_invoice.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.inner_invoice.RecordPk.Builder newBuilder(nlmk.l3.transport.inner_invoice.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.transport.inner_invoice.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.inner_invoice.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.inner_invoice.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.transport.inner_invoice.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.waybillNum)) {
        this.waybillNum = data().deepCopy(fields()[0].schema(), other.waybillNum);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.inner_invoice.RecordPk.Builder setWaybillNum(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.inner_invoice.RecordPk.Builder clearWaybillNum() {
      waybillNum = null;
