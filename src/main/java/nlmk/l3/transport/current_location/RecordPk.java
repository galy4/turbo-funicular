...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3274023814477710679L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.l3.transport.current_location\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"ИД операции перемещения\"}]}");
   ...
   * @param id ИД операции перемещения
   */
   ...
   * @return ИД операции перемещения
   */
  public long getId() {
    return id;
  }
   ...
   */
  public static nlmk.l3.transport.current_location.RecordPk.Builder newBuilder() {
    return new nlmk.l3.transport.current_location.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.current_location.RecordPk.Builder newBuilder(nlmk.l3.transport.current_location.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.current_location.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.current_location.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.current_location.RecordPk.Builder newBuilder(nlmk.l3.transport.current_location.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.transport.current_location.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.current_location.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.current_location.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.transport.current_location.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.current_location.RecordPk.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.current_location.RecordPk.Builder clearId() {
