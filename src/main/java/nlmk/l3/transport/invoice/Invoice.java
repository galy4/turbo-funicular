...
public class Invoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Код операции */
   private nlmk.l3.transport.invoice.enum_op op;
  /** Ключ объекта */
   private nlmk.l3.transport.invoice.RecordPk pk;
   private nlmk.l3.transport.invoice.RecordData data;
   ...
   */
  public Invoice(java.lang.String ts, nlmk.l3.transport.invoice.enum_op op, nlmk.l3.transport.invoice.RecordPk pk, nlmk.l3.transport.invoice.RecordData data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: op = (nlmk.l3.transport.invoice.enum_op)value$; break;
    case 2: pk = (nlmk.l3.transport.invoice.RecordPk)value$; break;
    case 3: data = (nlmk.l3.transport.invoice.RecordData)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return Код операции
   */
  public nlmk.l3.transport.invoice.enum_op getOp() {
    return op;
  }
   ...
   * @param value the value to set.
   */
  public void setOp(nlmk.l3.transport.invoice.enum_op value) {
    this.op = value;
  }
   ...
   * @return Ключ объекта
   */
  public nlmk.l3.transport.invoice.RecordPk getPk() {
    return pk;
  }
   ...
   * @param value the value to set.
   */
  public void setPk(nlmk.l3.transport.invoice.RecordPk value) {
    this.pk = value;
  }
   ...
   */
  public nlmk.l3.transport.invoice.RecordData getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(nlmk.l3.transport.invoice.RecordData value) {
    this.data = value;
  }
   ...
   */
  public static nlmk.l3.transport.invoice.Invoice.Builder newBuilder() {
    return new nlmk.l3.transport.invoice.Invoice.Builder();
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static nlmk.l3.transport.invoice.Invoice.Builder newBuilder(nlmk.l3.transport.invoice.Invoice.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.invoice.Invoice.Builder();
    } else {
      return new nlmk.l3.transport.invoice.Invoice.Builder(other);
    }
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static nlmk.l3.transport.invoice.Invoice.Builder newBuilder(nlmk.l3.transport.invoice.Invoice other) {
    if (other == null) {
      return new nlmk.l3.transport.invoice.Invoice.Builder();
    } else {
      return new nlmk.l3.transport.invoice.Invoice.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Invoice>
    ...
    /** Ключ объекта */
    private nlmk.l3.transport.invoice.RecordPk pk;
    private nlmk.l3.transport.invoice.RecordPk.Builder pkBuilder;
    private nlmk.l3.transport.invoice.RecordData data;
    private nlmk.l3.transport.invoice.RecordData.Builder dataBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.invoice.Invoice.Builder other) {
      super(other);
      ...
      if (other.hasPkBuilder()) {
        this.pkBuilder = nlmk.l3.transport.invoice.RecordPk.newBuilder(other.getPkBuilder());
      }
      ...
      if (other.hasDataBuilder()) {
        this.dataBuilder = nlmk.l3.transport.invoice.RecordData.newBuilder(other.getDataBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.transport.invoice.Invoice other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder setTs(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder setOp(nlmk.l3.transport.invoice.enum_op value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder setPk(nlmk.l3.transport.invoice.RecordPk value) {
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.invoice.RecordPk.Builder getPkBuilder() {
      if (pkBuilder == null) {
        if (hasPk()) {
          setPkBuilder(nlmk.l3.transport.invoice.RecordPk.newBuilder(pk));
        } else {
          setPkBuilder(nlmk.l3.transport.invoice.RecordPk.newBuilder());
        }
      }
      return pkBuilder;
    }
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.invoice.Invoice.Builder setPkBuilder(nlmk.l3.transport.invoice.RecordPk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder setData(nlmk.l3.transport.invoice.RecordData value) {
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.invoice.RecordData.Builder getDataBuilder() {
      if (dataBuilder == null) {
        if (hasData()) {
          setDataBuilder(nlmk.l3.transport.invoice.RecordData.newBuilder(data));
        } else {
          setDataBuilder(nlmk.l3.transport.invoice.RecordData.newBuilder());
        }
      }
      return dataBuilder;
    }
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.invoice.Invoice.Builder setDataBuilder(nlmk.l3.transport.invoice.RecordData.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.Invoice.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public Invoice build() {
      try {
        ...
        record.op = fieldSetFlags()[1] ? this.op : (nlmk.l3.transport.invoice.enum_op) defaultValue(fields()[1]);
        if (pkBuilder != null) {
          try {
          ...
          record.pk = fieldSetFlags()[2] ? this.pk : (nlmk.l3.transport.invoice.RecordPk) defaultValue(fields()[2]);
        }
        if (dataBuilder != null) {
          try {
          ...
          record.data = fieldSetFlags()[3] ? this.data : (nlmk.l3.transport.invoice.RecordData) defaultValue(fields()[3]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.op = nlmk.l3.transport.invoice.enum_op.values()[in.readEnum()];

      if (this.pk == null) {
        this.pk = new nlmk.l3.transport.invoice.RecordPk();
      }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.data == null) {
          this.data = new nlmk.l3.transport.invoice.RecordData();
        }
