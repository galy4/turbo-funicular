...
public class RecordPositions extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static nlmk.l3.transport.invoice.RecordPositions.Builder newBuilder() {
    return new nlmk.l3.transport.invoice.RecordPositions.Builder();
  }
   ...
   * @return A new RecordPositions RecordBuilder
   */
  public static nlmk.l3.transport.invoice.RecordPositions.Builder newBuilder(nlmk.l3.transport.invoice.RecordPositions.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.invoice.RecordPositions.Builder();
    } else {
      return new nlmk.l3.transport.invoice.RecordPositions.Builder(other);
    }
  }
   ...
   * @return A new RecordPositions RecordBuilder
   */
  public static nlmk.l3.transport.invoice.RecordPositions.Builder newBuilder(nlmk.l3.transport.invoice.RecordPositions other) {
    if (other == null) {
      return new nlmk.l3.transport.invoice.RecordPositions.Builder();
    } else {
      return new nlmk.l3.transport.invoice.RecordPositions.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPositions>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.invoice.RecordPositions.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder setWagonNum(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder clearWagonNum() {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder setWagonType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder clearWagonType() {
      wagonType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder setWeightNet(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder clearWeightNet() {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder setWaybillWagonLink(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.invoice.RecordPositions.Builder clearWaybillWagonLink() {
