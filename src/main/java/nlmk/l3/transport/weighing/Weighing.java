...
public class Weighing extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageDecoder<Weighing> DECODER =
      new BinaryMessageDecoder<Weighing>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<Weighing> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Weighing> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Weighing> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Weighing>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this Weighing to a ByteBuffer.
  ...
  /**
   * Deserializes a Weighing from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a Weighing instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static Weighing fromByteBuffer(
   ...
   */
  public Weighing(java.lang.String ts, nlmk.l3.transport.weighing.enum_op op, nlmk.l3.transport.weighing.RecordPk pk, nlmk.l3.transport.weighing.RecordData data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: op = (nlmk.l3.transport.weighing.enum_op)value$; break;
    case 2: pk = (nlmk.l3.transport.weighing.RecordPk)value$; break;
    case 3: data = (nlmk.l3.transport.weighing.RecordData)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return Код операции
   */
  public nlmk.l3.transport.weighing.enum_op getOp() {
    return op;
  }
   ...
   * @param value the value to set.
   */
  public void setOp(nlmk.l3.transport.weighing.enum_op value) {
    this.op = value;
  }
   ...
   * @return Ключ записи
   */
  public nlmk.l3.transport.weighing.RecordPk getPk() {
    return pk;
  }
   ...
   * @param value the value to set.
   */
  public void setPk(nlmk.l3.transport.weighing.RecordPk value) {
    this.pk = value;
  }
   ...
   */
  public nlmk.l3.transport.weighing.RecordData getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(nlmk.l3.transport.weighing.RecordData value) {
    this.data = value;
  }

  /**
   * Creates a new Weighing RecordBuilder.
   * @return A new Weighing RecordBuilder
   */
  public static nlmk.l3.transport.weighing.Weighing.Builder newBuilder() {
    return new nlmk.l3.transport.weighing.Weighing.Builder();
  }

  /**
   * Creates a new Weighing RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new Weighing RecordBuilder
   */
  public static nlmk.l3.transport.weighing.Weighing.Builder newBuilder(nlmk.l3.transport.weighing.Weighing.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.weighing.Weighing.Builder();
    } else {
      return new nlmk.l3.transport.weighing.Weighing.Builder(other);
    }
  }

  /**
   * Creates a new Weighing RecordBuilder by copying an existing Weighing instance.
   * @param other The existing instance to copy.
   * @return A new Weighing RecordBuilder
   */
  public static nlmk.l3.transport.weighing.Weighing.Builder newBuilder(nlmk.l3.transport.weighing.Weighing other) {
    if (other == null) {
      return new nlmk.l3.transport.weighing.Weighing.Builder();
    } else {
      return new nlmk.l3.transport.weighing.Weighing.Builder(other);
  ...
  /**
   * RecordBuilder for Weighing instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weighing>
    implements org.apache.avro.data.RecordBuilder<Weighing> {
    ...
    /** Ключ записи */
    private nlmk.l3.transport.weighing.RecordPk pk;
    private nlmk.l3.transport.weighing.RecordPk.Builder pkBuilder;
    private nlmk.l3.transport.weighing.RecordData data;
    private nlmk.l3.transport.weighing.RecordData.Builder dataBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.weighing.Weighing.Builder other) {
      super(other);
      ...
      if (other.hasPkBuilder()) {
        this.pkBuilder = nlmk.l3.transport.weighing.RecordPk.newBuilder(other.getPkBuilder());
      }
      ...
      if (other.hasDataBuilder()) {
        this.dataBuilder = nlmk.l3.transport.weighing.RecordData.newBuilder(other.getDataBuilder());
      }
    }

    /**
     * Creates a Builder by copying an existing Weighing instance
     * @param other The existing instance to copy.
     */
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder setTs(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder setOp(nlmk.l3.transport.weighing.enum_op value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder setPk(nlmk.l3.transport.weighing.RecordPk value) {
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.weighing.RecordPk.Builder getPkBuilder() {
      if (pkBuilder == null) {
        if (hasPk()) {
          setPkBuilder(nlmk.l3.transport.weighing.RecordPk.newBuilder(pk));
        } else {
          setPkBuilder(nlmk.l3.transport.weighing.RecordPk.newBuilder());
        }
      }
      return pkBuilder;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder setData(nlmk.l3.transport.weighing.RecordData value) {
     ...
     * @return This builder.
     */
    public nlmk.l3.transport.weighing.RecordData.Builder getDataBuilder() {
      if (dataBuilder == null) {
        if (hasData()) {
          setDataBuilder(nlmk.l3.transport.weighing.RecordData.newBuilder(data));
        } else {
          setDataBuilder(nlmk.l3.transport.weighing.RecordData.newBuilder());
        }
      }
      return dataBuilder;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.Weighing.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public Weighing build() {
      try {
        Weighing record = new Weighing();
        record.ts = fieldSetFlags()[0] ? this.ts : (java.lang.String) defaultValue(fields()[0]);
        record.op = fieldSetFlags()[1] ? this.op : (nlmk.l3.transport.weighing.enum_op) defaultValue(fields()[1]);
        if (pkBuilder != null) {
          try {
          ...
          record.pk = fieldSetFlags()[2] ? this.pk : (nlmk.l3.transport.weighing.RecordPk) defaultValue(fields()[2]);
        }
        if (dataBuilder != null) {
          try {
          ...
          record.data = fieldSetFlags()[3] ? this.data : (nlmk.l3.transport.weighing.RecordData) defaultValue(fields()[3]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Weighing>
    WRITER$ = (org.apache.avro.io.DatumWriter<Weighing>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Weighing>
    READER$ = (org.apache.avro.io.DatumReader<Weighing>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.op = nlmk.l3.transport.weighing.enum_op.values()[in.readEnum()];

      if (this.pk == null) {
        this.pk = new nlmk.l3.transport.weighing.RecordPk();
      }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.data == null) {
          this.data = new nlmk.l3.transport.weighing.RecordData();
        }
