...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static nlmk.l3.transport.weighing.RecordPk.Builder newBuilder() {
    return new nlmk.l3.transport.weighing.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.weighing.RecordPk.Builder newBuilder(nlmk.l3.transport.weighing.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.weighing.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.weighing.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.weighing.RecordPk.Builder newBuilder(nlmk.l3.transport.weighing.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.transport.weighing.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.weighing.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.weighing.RecordPk.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.RecordPk.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.weighing.RecordPk.Builder clearId() {
      id = null;
