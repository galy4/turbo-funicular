...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1896062331701139948L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.l3.transport\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Идентификатор сертификата\"}]}");
   ...
   */
  public RecordPk(java.lang.String id) {
    this.id = id;
  }
   ...
   * @return Идентификатор сертификата
   */
   ...
   */
  public static nlmk.l3.transport.RecordPk.Builder newBuilder() {
    return new nlmk.l3.transport.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.RecordPk.Builder newBuilder(nlmk.l3.transport.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.transport.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.transport.RecordPk.Builder newBuilder(nlmk.l3.transport.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.transport.RecordPk.Builder();
    } else {
      return new nlmk.l3.transport.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.transport.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.transport.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.RecordPk.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.transport.RecordPk.Builder clearId() {
      id = null;
